...
import { t as takeCoverageInsideWorker } from './coverage.BtDxDqSU.js';
import { r as rpc } from './rpc.DWKX1ZbI.js';
import { l as loadDiffConfig, a as loadSnapshotSerializers } from './setup-common.D5-2VgqG.js';
import { g as getWorkerState } from './utils.DYj33du9.js';
import { T as TestRunner } from './index.OVGXnVRj.js';
...
async function resolveSnapshotEnvironment(config, moduleRunner) {
	if (!config.snapshotEnvironment) {
		const { VitestNodeSnapshotEnvironment } = await import('./node.Es9ukMGX.js');
